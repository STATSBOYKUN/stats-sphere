...
export const sampleSkewness = (arr: number[]): number => {
...
export const sampleKurtosis = (arr: number[]): number => {
...
export const quantileSorted = (sortedArr: number[], q: number): number => {

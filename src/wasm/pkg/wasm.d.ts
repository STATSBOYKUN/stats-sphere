...
export function burg_alg(p: number, data: Float64Array): Float64Array;
export class Arima {
  free(): void;
  ...
  intercept_se(): number;
  intercept_se2(): number;
  intercept_se3(): number;
  coeficient_se(): Float64Array;
  coeficient_se2(): Float64Array;
  ...
  est_res2(intercept: number, ar: Float64Array, ma: Float64Array, data: Float64Array): Float64Array;
...
export interface InitOutput {
  ...
  readonly arima_intercept_se2: (a: number) => number;
  readonly arima_intercept_se3: (a: number) => number;
  readonly arima_coeficient_se: (a: number) => [number, number];
  readonly arima_coeficient_se2: (a: number) => [number, number];
  ...
  readonly arima_est_res2: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number];
  ...
  readonly burg_alg: (a: number, b: number, c: number) => [number, number];

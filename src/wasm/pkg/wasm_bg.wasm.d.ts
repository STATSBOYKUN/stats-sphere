...
export const discriminantanalysis_get_executed_functions: (a: number) => [number, number, number];
export const discriminantanalysis_get_all_errors: (a: number) => any;
export const discriminantanalysis_clear_errors: (a: number) => any;
...
export const analyze_discriminant: (a: any, b: any, c: any, d: any, e: any, f: any, g: any) => [number, number, number];

...
export const __wbg_discriminantanalysisresult_free: (a: number, b: number) => void;
export const discriminant_analysis: (a: any, b: any) => any;
export const start_analysis: (a: any, b: any, c: number, d: number) => [number, number, number];
export const js_array_to_vec_f64: (a: any) => [number, number, number, number];
export const get_group_means: (a: any) => [number, number, number];
export const get_overall_means: (a: any) => [number, number, number];
export const get_f_values: (a: any) => [number, number, number];
export const get_lambda_values: (a: any) => [number, number, number];
export const get_selected_variables: (a: any) => [number, number, number];
export const get_valid_groups: (a: any) => [number, number, number];
export const get_success_status: (a: any) => [number, number, number];
export const get_error_message: (a: any) => [number, number, number, number];
export const __wbg_sliceddata_free: (a: number, b: number) => void;
export const check_sliced_data: (a: any) => any;
...
export const __wbg_rangestats_free: (a: number, b: number) => void;
export const __wbg_statistics_free: (a: number, b: number) => void;
export const group_statistics: (a: any, b: any, c: number, d: number) => any;

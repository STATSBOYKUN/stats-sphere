...
export const __wbg_correspondenceanalysis_free: (a: number, b: number) => void;
export const correspondenceanalysis_new: (a: any, b: any, c: any, d: any, e: any) => [number, number, number];
export const correspondenceanalysis_get_results: (a: number) => [number, number, number];
export const correspondenceanalysis_get_all_errors: (a: number) => any;
export const correspondenceanalysis_clear_errors: (a: number) => any;

...
export const autocorrelation_calculate_bartlet_left: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
export const autocorrelation_calculate_bartlet_right: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
...
export const dickeyfuller_get_r_square: (a: number) => [number, number];
...
export const dickeyfuller_set_r_square: (a: number, b: number, c: number) => void;
...
export const augmenteddickeyfuller_get_r_square: (a: number) => [number, number];
...
export const augmenteddickeyfuller_set_r_square: (a: number, b: number, c: number) => void;
...
export const arima_ln_likelihood: (a: number) => number;
export const arima_aic: (a: number) => number;
export const arima_bic: (a: number) => number;
export const arima_sbc: (a: number) => number;
...
export const arima_estimate_residual: (a: number) => [number, number];
...
export const arima_forecast: (a: number, b: number) => [number, number];
...
export const arima_z_stat: (a: number) => [number, number];

...
export const arima_intercept_se2: (a: number) => number;
export const arima_intercept_se3: (a: number) => number;
export const arima_coeficient_se: (a: number) => [number, number];
export const arima_coeficient_se2: (a: number) => [number, number];
...
export const arima_est_res2: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number];
...
export const burg_alg: (a: number, b: number, c: number) => [number, number];

...
export const __wbg_twostepclusteranalysis_free: (a: number, b: number) => void;
export const twostepclusteranalysis_new: (a: any, b: any, c: any, d: any, e: any) => [number, number, number];
export const twostepclusteranalysis_get_results: (a: number) => [number, number, number];
export const twostepclusteranalysis_get_executed_functions: (a: number) => [number, number, number];
export const twostepclusteranalysis_get_all_errors: (a: number) => any;
export const twostepclusteranalysis_clear_errors: (a: number) => any;

...
export const __wbg_kmeansclusteranalysis_free: (a: number, b: number) => void;
export const kmeansclusteranalysis_new: (a: any, b: any, c: any, d: any, e: any) => [number, number, number];
export const kmeansclusteranalysis_get_results: (a: number) => [number, number, number];
export const kmeansclusteranalysis_get_executed_functions: (a: number) => [number, number, number];
export const kmeansclusteranalysis_get_all_errors: (a: number) => any;
export const kmeansclusteranalysis_clear_errors: (a: number) => any;

...
export const __wbg_factoranalysis_free: (a: number, b: number) => void;
export const factoranalysis_new: (a: any, b: any, c: any, d: any, e: any) => [number, number, number];
export const factoranalysis_get_results: (a: number) => [number, number, number];
export const factoranalysis_get_all_errors: (a: number) => any;
export const factoranalysis_clear_errors: (a: number) => any;

...
export const __wbg_rocanalysis_free: (a: number, b: number) => void;
export const rocanalysis_new: (a: any, b: any, c: any, d: any, e: any, f: any, g: any) => [number, number, number];
export const rocanalysis_get_results: (a: number) => [number, number, number];
export const rocanalysis_get_executed_functions: (a: number) => [number, number, number];
export const rocanalysis_get_all_errors: (a: number) => any;
export const rocanalysis_clear_errors: (a: number) => any;

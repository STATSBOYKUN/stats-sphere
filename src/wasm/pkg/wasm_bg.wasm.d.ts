...
export const kmeansclusteringwasm_get_iterations_direct: (a: number) => [number, number, number];
export const kmeansclusteringwasm_get_iterations_detailed: (a: number) => [number, number, number];
export const kmeansclusteringwasm_get_iteration_history_table: (a: number) => [number, number, number];

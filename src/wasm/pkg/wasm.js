...
export class HierarchicalCluster {
     ...
     */
    constructor(cluster_data, label_data, config_data, cluster_data_defs, label_data_defs) {
        const ret = wasm.hierarchicalcluster_new(cluster_data, label_data, config_data, cluster_data_defs, label_data_defs);
        if (ret[2]) {

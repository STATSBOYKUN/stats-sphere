...
pub fn run_analysis(
...
) -> Result<Option<PrincipalComponentAnalysisResult>, JsValue> {
    ...
    let result = PrincipalComponentAnalysisResult {
        descriptive_statistics: descriptive_statistics.unwrap_or_default(),
        scree_plot: scree_plot.unwrap_or_default(),
        correlation_matrix: correlation_matrix.unwrap_or_default(),
        inverse_correlation_matrix: inverse_correlation_matrix.unwrap_or_default(),
        kmo_bartletts_test: kmo_bartletts_test.unwrap_or_default(),
        anti_image_matrices: anti_image_matrices.unwrap_or_default(),
        communalities: communalities.unwrap_or_default(),
        total_variance_explained: total_variance_explained.unwrap_or_default(),
        component_matrix: component_matrix.unwrap_or_default(),
        reproduced_correlations: reproduced_correlations.unwrap_or_default(),
        rotated_component_matrix: rotated_component_matrix.unwrap_or_default(),
        component_transformation_matrix: component_transformation_matrix.unwrap_or_default(),
        component_score_coefficient_matrix: component_score_coefficient_matrix.unwrap_or_default(),
        component_score_covariance_matrix: component_score_covariance_matrix.unwrap_or_default(),
    };

    Ok(Some(result))
}

pub fn get_results(result: &Option<PrincipalComponentAnalysisResult>) -> Result<JsValue, JsValue> {
    match result {

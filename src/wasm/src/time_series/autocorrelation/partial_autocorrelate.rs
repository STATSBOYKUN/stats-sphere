...
impl Autocorrelation{
    pub fn calculate_partial_autocorrelate(&self, autocorrelate: Vec<f64>) -> Vec<f64>{
    ...
    pub fn calculate_partial_autocorrelation_se(&self, partial_autocorelate: Vec<f64>) -> Vec<f64>{

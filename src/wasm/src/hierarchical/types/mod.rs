...
pub enum DistanceMetric {
    ...
    Correlation,
    Minkowski,
    Customized, // Custom power & root parameters
...
pub struct ClusteringConfig {
    ...
    pub custom_power: Option<f64>,
    pub custom_root: Option<f64>,
    pub binary_options: Option<BinaryOptions>,
    pub standardize_by_case: bool,
}

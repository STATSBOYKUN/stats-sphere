...
interface StationaryTestModalProps {
  onClose: () => void;
}

const StationaryTestModal: React.FC<StationaryTestModalProps> = ({ onClose }) => {
  ...
  return (
    <DialogContent className="max-w-[60vw] max-h-[80vh] grid grid-cols-1 overflow-y-auto">
        <div className="py-4">
            <DialogHeader>
                <DialogTitle>Stationary Test</DialogTitle>
...
export default StationaryTestModal;
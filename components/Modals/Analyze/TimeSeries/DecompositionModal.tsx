...
const DecompositionModal: React.FC<DecompositionModalProps> = ({ onClose }) => {
    ...
    const [selectedContains, setSelectedContains] = useState<string | null>(null);

    const handleSelectedMethod = (value: string) => {
        setSelectedMethod(value);
        setSelectedSave('selected');
        setSelectedContains('selected');
    };
                    ...
                    <div className="border-2 rounded-md w-[420px] py-2">
                        ...
                        <div className="flex flex-col gap-2 p-2">
                            <div className="flex flex-row gap-2 ml-8">
                                <Checkbox 
                                    checked={selectedContains !== null} 
                                    onCheckedChange={(isChecked) => setSelectedContains(isChecked ? "selected" : null)}
                                />

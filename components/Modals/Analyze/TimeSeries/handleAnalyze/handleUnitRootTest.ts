import init, {DickeyFuller, AugmentedDickeyFuller, get_beta_inf, get_gamma_0_tab1} from '../../../../../src/wasm/pkg/wasm.js';
...
export async function handleUnitRootTest(
    ...
    try {
        ...
        return [[coeficient], "statisticJSON", "criticalJSON", methodName];
    } catch (error) {

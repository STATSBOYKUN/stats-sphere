...
import {MultivariateModelProps, MultivariateModelType} from "@/models/general-linear-model/multivariate/multivariate";
...
export const MultivariateModel = ({isModelOpen, setIsModelOpen, updateFormData, data}: MultivariateModelProps) => {
    const [modelState, setModelState] = useState<MultivariateModelType>({...data});
    ...
    const handleChange = (field: keyof MultivariateModelType, value: CheckedState | number | string | null) => {
                            ...
                            >
                                <ResizablePanel defaultSize={15}>
                                    <div className="flex flex-col gap-2 p-2">
                                        ...
                                        <RadioGroup
                                            value={modelState.NonCust ? "NonCust" : modelState.Custom ? "Custom" : "BuildCustomTerm"}
                                            onValueChange={handleSpecifyGrp}
                                        >
                                            <div className="grid grid-cols-3">
                                                <div className="flex items-center space-x-2">
                                                    <RadioGroupItem value="NonCust" id="NonCust"/>
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    <RadioGroupItem value="BuildCustomTerm" id="BuildCustomTerm"/>
                                ...
                                <ResizablePanel defaultSize={60}>
                                    <ResizablePanelGroup direction="horizontal">
                                        ...
                                        <ResizablePanel defaultSize={20}>
                                            <div className="flex flex-col gap-2 p-2">
                                                <Label className="font-bold">Build Term(s):</Label>
                                                <div className="flex items-center space-x-2">
                                                    <Label className="w-[75px]">Type:</Label>
                                                    <Select
                                                        value={modelState.BuildTermMethod ?? ""}
                                                        onValueChange={(value) => handleChange("BuildTermMethod", value)}
                                                    >
                                                        <SelectTrigger>
                                                            <SelectValue/>
                                                        </SelectTrigger>
                                        ...
                                        <ResizablePanel defaultSize={30}>
                                            <div className="w-full p-2">
                                                ...
                                                <Input
                                                    ...
                                                    className="w-full"
                                                    placeholder=""
                                                    value={modelState.FactorsModel ?? ""}
                                                    onChange={(e) => handleChange("FactorsModel", e.target.value)}
                                                />
                                            </div>
                                        </ResizablePanel>
                                    </ResizablePanelGroup>
                                        ...
                                        <Table>
                                            <TableHeader>
                                                <TableRow>
                                                    ...
                                                    <TableHead>Clear Term</TableHead>
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div className="flex items-center space-x-2">
                                ...
                                <Select
                                    ...
                                    onValueChange={(value) => handleChange("SumOfSquareMethod", value)}
                                >
                                    <SelectTrigger>
                                        <SelectValue/>
                                    </SelectTrigger>
                            ...
                            <div className="flex items-center space-x-2">
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) => handleChange("Intercept", checked)}
                                />
                                <label
                                    htmlFor="Intercept"

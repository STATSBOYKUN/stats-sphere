...
import {MultivariatePlotsProps, MultivariatePlotsType} from "@/models/general-linear-model/multivariate/multivariate";
...
export const MultivariatePlots = ({isPlotsOpen, setIsPlotsOpen, updateFormData, data}: MultivariatePlotsProps) => {
    const [plotsState, setPlotsState] = useState<MultivariatePlotsType>({...data});
    ...
    const handleChange = (field: keyof MultivariatePlotsType, value: CheckedState | number | string | null) => {
        ...
        <>
            ...
            <Dialog open={isPlotsOpen} onOpenChange={setIsPlotsOpen}>
                <DialogContent className="sm:max-w-lg">
                    <DialogHeader>
                        <DialogTitle>Multivariate: Plots</DialogTitle>
                    </DialogHeader>
                    <Separator/>

...
import {UnivariateModelProps, UnivariateModelType} from "@/models/general-linear-model/univariate/univariate";
...
export const UnivariateModel = ({ isModelOpen, setIsModelOpen, updateFormData, data }: UnivariateModelProps) => {
    const [modelState, setModelState] = useState<UnivariateModelType>({ ...data });
    ...
    const handleChange = (field: keyof UnivariateModelType, value: CheckedState | number | string | null) => {

...
import {UnivariateBootstrapProps, UnivariateBootstrapType} from "@/models/general-linear-model/univariate/univariate";
...
export const UnivariateBootstrap = ({ isBootstrapOpen, setIsBootstrapOpen, updateFormData, data }: UnivariateBootstrapProps) => {
    const [bootstrapState, setBootstrapState] = useState<UnivariateBootstrapType>({ ...data });
    ...
    const handleChange = (field: keyof UnivariateBootstrapType, value: CheckedState | number | string | null) => {
        ...
        <>
            ...
            <Dialog open={isBootstrapOpen} onOpenChange={setIsBootstrapOpen}>
                <DialogContent className="sm:max-w-lg">
                    <DialogHeader>
                        <DialogTitle>Univariate: Bootstrap</DialogTitle>
                    </DialogHeader>
                    <Separator />

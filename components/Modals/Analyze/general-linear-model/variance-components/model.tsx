...
export const VarianceCompsModel = ({isModelOpen, setIsModelOpen, updateFormData, data}: VarianceCompsModelProps) => {
    const [modelState, setModelState] = useState<VarianceCompsModelType>({...data});
    ...
    const handleChange = (field: keyof VarianceCompsModelType, value: CheckedState | number | string | null) => {
                            ...
                            >
                                <ResizablePanel defaultSize={20}>
                                    <div className="flex flex-col gap-2 p-2">
                                        ...
                                        <RadioGroup
                                            value={modelState.NonCust ? "NonCust" : modelState.Custom ? "Custom" : ""}

...
export const RepeatedMeasuresEMMeans = ({ isEMMeansOpen, setIsEMMeansOpen, updateFormData, data }: RepeatedMeasuresEMMeansProps) => {
    const [EMMeansState, setEMMeansState] = useState<RepeatedMeasuresEMMeansType>({ ...data });
    ...
    const handleChange = (field: keyof RepeatedMeasuresEMMeansType, value: CheckedState | number | string | null) => {

...
export const RepeatedMeasuresPlots = ({ isPlotsOpen, setIsPlotsOpen, updateFormData, data }: RepeatedMeasuresPlotsProps) => {
    const [plotsState, setPlotsState] = useState<RepeatedMeasuresPlotsType>({ ...data });
    ...
    const handleChange = (field: keyof RepeatedMeasuresPlotsType, value: CheckedState | number | string | null) => {

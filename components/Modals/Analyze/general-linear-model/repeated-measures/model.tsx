...
export const RepeatedMeasuresModel = ({ isModelOpen, setIsModelOpen, updateFormData, data }: RepeatedMeasuresModelProps) => {
    const [modelState, setModelState] = useState<RepeatedMeasuresModelType>({ ...data });
    ...
    const handleChange = (field: keyof RepeatedMeasuresModelType, value: CheckedState | number | string | null) => {
                                ...
                                <ResizablePanel defaultSize={60}>
                                    <ResizablePanelGroup direction="horizontal">
                                        <ResizablePanel defaultSize={30}>
                                            <div className="w-full p-2">
                                                ...
                                                <Input
                                                    ...
                                                    className="w-full"
                                                    placeholder=""
                                                    value={modelState.BetSubVar ?? ""}
                                                    onChange={(e) => handleChange("BetSubVar", e.target.value)}
                                                />
                                            </div>
                                        </ResizablePanel>
                                        <ResizableHandle/>
                                        ...
                                        <ResizablePanel defaultSize={40}>
                                            <div className="w-full p-2">
                                                <Label>Between-Subjects Model: </Label>
                                                <Input
                                                    id="BetSubModel"
                                                    type="text"
                                                    className="w-full"
                                                    placeholder=""
                                                    value={modelState.BetSubModel ?? ""}
                                                    onChange={(e) => handleChange("BetSubModel", e.target.value)}
                                                />
                                            </div>
                                        </ResizablePanel>
                                    </ResizablePanelGroup>

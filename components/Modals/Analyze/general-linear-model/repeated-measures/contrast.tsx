...
export const RepeatedMeasuresContrast = ({ isContrastOpen, setIsContrastOpen, updateFormData, data }: RepeatedMeasuresContrastProps) => {
    const [contrastState, setContrastState] = useState<RepeatedMeasuresContrastType>({ ...data });
    ...
    const handleChange = (field: keyof RepeatedMeasuresContrastType, value: number | string | null) => {

...
export const OptScaOveralsDefineRangeScale = ({ isDefineRangeScaleOpen, setIsDefineRangeScaleOpen, updateFormData, data }: OptScaOveralsDefineRangeScaleProps) => {
    const [defineRangeScaleState, setDefineRangeScaleState] = useState<OptScaOveralsDefineRangeScaleType>({ ...data });
    ...
    const handleChange = (field: keyof OptScaOveralsDefineRangeScaleType, value: number | string | null) => {
    ...
    const handleContinue = () => {
        Object.entries(defineRangeScaleState).forEach(([key, value]) => {
            updateFormData(key as keyof OptScaOveralsDefineRangeScaleType, value);
        });
                    ...
                    >
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <div className="w-[75px]">
                                        <Input
                                            ...
                                            type="number"
                                            placeholder=""
                                            value={defineRangeScaleState.Minimum || 1}
                                ...
                                <div className="flex items-center space-x-2">
                                    ...
                                    <div className="w-[75px]">
                                        <Input
                                            ...
                                            type="number"
                                            placeholder=""
                                            value={defineRangeScaleState.Maximum || ""}
                        ...
                        <ResizablePanel defaultSize={60}>
                            <div className="flex flex-col gap-2 p-2">
                                <Label className="font-bold">Measurement Scale</Label>
                                <RadioGroup
                                    value={
                                        defineRangeScaleState.Ordinal ? "Ordinal" :
                                            defineRangeScaleState.SingleNominal ? "SingleNominal" :
                                                defineRangeScaleState.MultipleNominal ? "MultipleNominal" :
                                                    defineRangeScaleState.DiscreteNumeric ? "DiscreteNumeric" : ""
                                    }
                                ...
                                >
                                    <div className="grid grid-cols-2 gap-2">
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                <RadioGroupItem value="SingleNominal" id="SingleNominal"/>
                                        ...
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="flex items-center space-x-2">
                                                <RadioGroupItem value="DiscreteNumeric" id="DiscreteNumeric"/>

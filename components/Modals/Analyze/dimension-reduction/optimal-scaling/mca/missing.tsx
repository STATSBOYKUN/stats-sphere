...
export const OptScaMCAMissing = ({ isMissingOpen, setIsMissingOpen, updateFormData, data }: OptScaMCAMissingProps) => {
    const [missingState, setMissingState] = useState<OptScaMCAMissingType>({ ...data });
    ...
    const handleChange = (field: keyof OptScaMCAMissingType, value: number | string | null) => {
        ...
        <>
            ...
            <Dialog open={isMissingOpen} onOpenChange={setIsMissingOpen}>
                <DialogContent className="sm:max-w-xl">
                    <DialogHeader>
                        <DialogTitle>Multiple Correspondence Analysis: Missing</DialogTitle>
                    </DialogHeader>
                    <Separator />
                    <ResizablePanelGroup
                        direction="vertical"

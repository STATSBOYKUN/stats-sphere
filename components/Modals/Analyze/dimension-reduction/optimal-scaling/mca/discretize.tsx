...
export const OptScaMCADiscretize = ({ isDiscretizeOpen, setIsDiscretizeOpen, updateFormData, data }: OptScaMCADiscretizeProps) => {
    const [discretizeState, setDiscretizeState] = useState<OptScaMCADiscretizeType>({ ...data });
    ...
    const handleChange = (field: keyof OptScaMCADiscretizeType, value: number | string | null) => {
        ...
        <>
            ...
            <Dialog open={isDiscretizeOpen} onOpenChange={setIsDiscretizeOpen}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle>Multiple Correspondence Analysis: Dicretize</DialogTitle>
                    </DialogHeader>
                    <Separator/>
